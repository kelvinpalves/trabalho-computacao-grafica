...
4. Utilizando o programa projecoes.c como refer�ncia, implemente um programa tiposdeprojecoes.c.
Este programa dever� conter mais sete op��es de teclado: t e f, para exibir o topo e o fundo do objeto, F e T,
para mostrar a frente e a face traseira, e e d, para mostrar a faces esquerda e direita, respectivamente, e a tecla c,
para mostrar o tri�ngulo do canto.
*/
